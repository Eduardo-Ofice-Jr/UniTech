...
const inputNomeFuncionario = document.querySelector('#input_nomefuncionario')
...
buttonSubmit.addEventListener('click', async (event) => {
    ...
    const nomeFuncionario = inputNomeFuncionario.value
    const sobrenomeFuncionario = inputSobrenome.value
    ...
    if (sobrenomeFuncionario === '' || nomeFuncionario === '' || sexo === '' || datanascimento === '' || morada === '' || contact === '' ||  username === '' || senha === '' ) {
